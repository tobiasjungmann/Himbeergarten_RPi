...
import proto.communication_pb2 as communication__pb2
...
class CommunicatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/smart_home.Communicator/SayHello',
...
def add_CommunicatorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'smart_home.Communicator', rpc_method_handlers)
...
class Communicator(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/smart_home.Communicator/SayHello',
