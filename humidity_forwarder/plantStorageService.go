...
func ForwardToPlantServer(deviceId string, sensorId int32, humidity int32, humidityInPercent int32) {
	...
	_, errStore := c.StoreHumidityEntry(ctx, &pb.StoreHumidityRequest{DeviceMAC: &deviceId, SensorId: &sensorId, Humidity: &humidity, HumidityInPercent: &humidityInPercent})
